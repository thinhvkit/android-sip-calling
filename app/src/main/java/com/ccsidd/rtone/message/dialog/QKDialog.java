package com.ccsidd.rtone.message.dialog;
...
//            });
    ...
    public QKDialog setContext(Context context) {
        mContext = context;
    ...
    public void show() {
        try {
            if (mContext instanceof MainActivity)
                super.show(((MainActivity) mContext).getFragmentManager(), null);
            else if (mContext instanceof MessageActivity)
                super.show(((MessageActivity) mContext).getFragmentManager(), null);
