package com.ccsidd.rtone.message;
...
import com.ccsidd.rtone.message.common.utils.Units;
import com.ccsidd.rtone.message.view.QKTextView;

public class ThemeManager {
    private final static String TAG = "ThemeManager";

    public static final int DEFAULT_COLOR = 0xff1565c0;
    ...
    public static void init(Context context) {
        ...
        initializeTheme(Theme.fromString(Theme.PREF_OFFWHITE));
    }
...
//        LiveViewManager.refreshViews(QKPreference.BACKGROUND);
    ...
    public static int getNeutralBubbleColor() {
        ...
        switch (mTheme) {
            ...
            default:
                return mResources.getColor(R.color.grey100);
        }
    }
...
/*
    ...
    public static void setColor(MessageActivity activity, int color) {
