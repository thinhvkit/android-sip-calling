...
public class AvatarView extends ImageView implements View.OnClickListener {
    ...
    /**
     * When setImageDrawable is called with a drawable, we rectangle crop to size of this view and use
    ...
    public AvatarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            mDefaultDrawable = ContextCompat.getDrawable(context, R.drawable.unknown_contact);
    ...
    private void setImageWhenReady() {
        ...
        if (getWidth() > 0 && getHeight() > 0) {
            ...
            if (mOriginalDrawable != null) {
                ...
                getBackground().setColorFilter(ThemeManager.getSentBubbleColor(), PorterDuff.Mode.SRC_ATOP);
            } else {
                super.setImageDrawable(mDefaultDrawable);
                getBackground().setColorFilter(ThemeManager.getSentBubbleColor(), PorterDuff.Mode.SRC_ATOP);
            }
