...
final class EmojiStickerArrayAdapter extends ArrayAdapter<Emoji> {
    ...
    @Nullable OnEmojiLongClickedListener onEmojiLongClickedListener;

    @SuppressWarnings("PMD.UseVarargs")
    EmojiStickerArrayAdapter(final Context context, final Emoji[] data) {
        super(context, R.layout.emoji_sticker_text_view, toList(data));
    }
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(R.layout.emoji_sticker_text_view, parent, false);
        ...
        view.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (onEmojiLongClickedListener != null) {
                    final ViewHolder tag = (ViewHolder) v.getTag();
                    onEmojiLongClickedListener.onEmojiLongClicked(tag.emoji);
                }
                return true;
            }
        });
    ...
    public void setOnEmojiLongClickedListener(@Nullable final OnEmojiLongClickedListener onEmojiLongClickedListener) {
        this.onEmojiLongClickedListener = onEmojiLongClickedListener;
    }
