...
import com.ccsidd.rtone.view.gifloading.GifLoadingView;

import static com.ccsidd.rtone.message.emoji.Utils.checkNotNull;

public final class EmojiStickerPopup {
    ...
    EmojiStickerPopup(@NonNull final View rootView, @NonNull final EmojiEditText emojiEditText, @Nullable final RecentEmoji recent) {
        ...
        final EmojiStickerView emojiView = new EmojiStickerView(context, new OnEmojiClickedListener() {
            @Override
...
//                recentEmoji.addEmoji(emoji);
        ...
        }, new OnEmojiLongClickedListener() {
            @Override
            public void onEmojiLongClicked(Emoji emoji) {
                mGifLoadingView.setImageResource(EmojiHandler.addEmojis(context, emoji.getEmoji()));
                mGifLoadingView.show(((Activity)context).getFragmentManager(), "");
            }
        }, this.recentEmoji);
...
//        Utils.removeOnGlobalLayoutListener(rootView, onGlobalLayoutListener);
    ...
    public static final class Builder {
         ...
         * @return builder for building {@link EmojiStickerPopup}
         */
        ...
        public EmojiStickerPopup build(final EmojiEditText emojiEditText) {
            checkNotNull(emojiEditText, "EmojiEditText can't be null");

            final EmojiStickerPopup emojiPopup = new EmojiStickerPopup(rootView, emojiEditText, recentEmoji);
