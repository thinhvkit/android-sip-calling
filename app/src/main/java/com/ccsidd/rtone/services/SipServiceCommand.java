...
import com.ccsidd.rtone.BuildConfig;
...
public class SipServiceCommand {
    ...
    protected static final String ACTION_RESTART_ACCOUNT = "restartAccount";
    ...
    protected static final String ACTION_RENEW_INVITE = "renewInvite";
    ...
    protected static final String ACTION_SEND_MESSAGE = "sendMessgae";
    protected static final String ACTION_ADD_BUDDY = "addBuddy";
    protected static final String ACTION_REMOVE_BUDDY= "removeBuddy";
    protected static final String ACTION_MERGE_AUDIO= "mergeAudio";
    ...
    public static void stop(Context context) {
        context.stopService(new Intent(context, VoIPService.class));
    }
     ...
     * {@link BroadcastEventReceiver#onCallState(String, int, pjsip_inv_state, pjsip_status_code, long, boolean, boolean, String)}
     * @param context application context
     * @param accountID account ID used to make the call
     ...
     * @param callID call ID
     */
    public static void renewInvite(Context context, String accountID, int callID) {
        checkAccount(accountID);

        Intent intent = new Intent(context, VoIPService.class);
        intent.setAction(ACTION_RENEW_INVITE);
        intent.putExtra(PARAM_ACCOUNT_ID, accountID);
        intent.putExtra(PARAM_CALL_ID, callID);
        context.startService(intent);
    }
     ...
     * @param accountID sip account data
     */
    public static void sendMessage(Context context, String accountID, String numberToSend, String body) {
        checkAccount(accountID);

        Intent intent = new Intent(context, VoIPService.class);
        intent.setAction(ACTION_SEND_MESSAGE);
        intent.putExtra(PARAM_ACCOUNT_ID, accountID);
        intent.putExtra(PARAM_NUMBER, numberToSend);
     ...
     * @param accountID sip account data
     */
    public static void addBuddy(Context context, String accountID, String number) {
        checkAccount(accountID);
     ...
     * @param accountID sip account data
     */
    public static void removeBuddy(Context context, String accountID, String number) {
        checkAccount(accountID);

        Intent intent = new Intent(context, VoIPService.class);
        intent.setAction(ACTION_REMOVE_BUDDY);
        intent.putExtra(PARAM_ACCOUNT_ID, accountID);
        intent.putExtra(PARAM_NUMBER, number);
        context.startService(intent);
    }
     ...
     * @param accountID sip account data
     */
    public static void mergeAudio(Context context, String accountID) {
        checkAccount(accountID);

        Intent intent = new Intent(context, VoIPService.class);
        intent.setAction(ACTION_MERGE_AUDIO);
        intent.putExtra(PARAM_ACCOUNT_ID, accountID);
        context.startService(intent);
    }
}
