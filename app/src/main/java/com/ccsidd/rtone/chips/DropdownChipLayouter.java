...
import com.ccsidd.rtone.chips.Queries.Query;
...
public class DropdownChipLayouter {
    ...
    public View bindView(View convertView, ViewGroup parent, RecipientEntry entry, int position,
        ...
        if (displayName == null && !showImage) {
            viewHolder.destinationView.setPadding(mContext.getResources().getDimensionPixelSize(com.ccsidd.rtone.R.dimen.padding_no_picture), 0, 0, 0);
        } else {
            ...
            switch (type) {
                case BASE_RECIPIENT:
                    ...
                    if (photoBytes != null && photoBytes.length > 0) {
                        ...
                        BaseRecipientAdapter.tryFetchPhoto(entry, mContext, null, true, -1);
    ...
    protected int getItemLayoutResId() {
        return com.ccsidd.rtone.R.layout.chips_recipient_dropdown_item;
    }
    ...
    protected int getAlternateItemLayoutResId() {
        return com.ccsidd.rtone.R.layout.chips_alternate_item;
    }
    ...
    protected int getDefaultPhotoResId() {
        return com.ccsidd.rtone.R.drawable.ic_contact_picture;
    }
